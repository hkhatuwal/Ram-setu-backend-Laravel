    ...
    <section class="panel">
          <div class="row">
             <div class="col-md-12 col-xs-6">
              <header class="panel-heading">Customers List
                        ...
                        @foreach ($customers as $index=>$key) 
                            <tr class='item<?= $key->id;?>'>
                              ...
                              <td class="visible-md visible-lg">
                                  ...
                                  <a  class="btn btn-sm btn-info show-tooltip act-no" title="Edit" href="{{ URL::to('admin/customers/') }}"  ><i class="fa fa-edit"></i></a>
