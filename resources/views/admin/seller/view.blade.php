          ...
          <div class="row">
            <div class="col-sm-12 card">
              <div class="card-header">
                  <header class="panel-heading">Seller
                    <!-- <a href="{{url('/admin/download/city')}}" class="pull-right btn btn-sm btn-info" style="margin: 2px;">
                      <i class="fa fa-download" aria-hidden="true"></i>Download
                    </a> -->
                    <a href="{{url('/admin/seller/create')}}" class="pull-right btn btn-sm btn-info" style="margin: 2px;">
                        ...
                        ?>
                            <tr class='item<?= $key->id;?>'>
                              ...
                              <td class="visible-md visible-lg">
                                  <div class="">
                                  <a  class="btn btn-sm btn-info show-tooltip act-no" title="View More" href="{{ URL::to('admin/seller/'.$key->id) }}"  ><i class="fa fa-eye"></i></a>      
                                  <a  class="btn btn-sm btn-info show-tooltip act-no" title="Edit" href="{{ URL::to('admin/seller/'.$key->id.'/edit') }}"  ><i class="fa fa-edit"></i></a>
