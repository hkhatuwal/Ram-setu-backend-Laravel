  ...
  <section class="wrapper">
    ...
    <section class="panel">
        <header class="panel-heading">
          <div class="row">
            <div class="col-sm-6">    
                  <h4 class="form-heading">Seller Details</h4>
            </div>      
           <div class="col-sm-6">
               <div class="pull-right"> 
                    <a href="{{url('/admin/seller')}}" class="btn btn-sm btn-info" >Back</a>
               </div> 
           </div>           
        </div>
        </header>
        <div class="panel-body">
            <div class="adv-table editable-table ">
              ...
              @if(!empty($data))
                 {!! Form::model($data,array('route' => ['admin.seller.update', $data->id],'method'=>'PATCH','files'=>'true','id' =>'seller_form')) !!}
              @else
                {!! Form::open(['url'=>['admin/seller'], 'method' => 'POST','files'=>'true','id' =>'seller_form']) !!}
              @endif 
              {{ csrf_field() }}
