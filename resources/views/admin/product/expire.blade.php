    ...
    <div class="row">
          <div class="col-lg-12">
              <ul class="breadcrumb">
                  ...
                  <li><a href="{{url('/admin/expired-product')}}">Declined Products</a></li>
              </ul>
          </div>
    </div>
    <section class="panel">
          <div class="row">
            <div class="col-sm-12 card">
              <div class="card-header">
                ...
                {!! Form::open(['url'=>['admin/expired-product'], 'class' => '','method' => 'POST','id' =>'filter_form']) !!}
                      {{ csrf_field() }}
                          <div class="row" id="searchorder">
                            <div class="col-sm-3">    
                                <h4>Declined Products</h4>
                            </div> 
                            <div class="col-sm-3"> 
                            ...
                            <div class="col-sm-3">
                              <div class="pull-right"> 
                                ...
                                <a href="{{url('/admin/product/create')}}" class="pull-right btn btn-sm btn-info" style="margin: 2px;">
