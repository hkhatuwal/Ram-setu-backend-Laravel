	...
	<tr>
		...
		<td class="header container">
				...
				<div class="content">
					...
					<tr>
						<td><a href="http://inddianstore.com/"><img src="{{ url('public/image/logo.png') }}" width="150px"/></a></td>
						<td align="right"><h6 class="collapse"><a href="http://inddianstore.com/">Inddianstore</h6></a></td>
					</tr>
				</table>
				</div>
			...
			<table>
				<tr>
					<td>
						...
						<p class="lead">Your order ({{$order->order->order_id}}) has been place from Inddianstore</p>
                  ...
                  <p>Order Subtotal ({{$order->order->currency}}) :<span class="pull-right">{{$order->order->subtotal}}</span></p>
                  <p>Discount ({{$order->order->currency}}) : <span class="pull-right">33</span></p>
                  <hr>
                  <p>Grand Total  ({{$order->order->currency}}):<span class="pull-right">{{$order->order->grand_total}}</span></p> 
                		            </td>
                		        </tr>
                		    </table>      
						</p>
				<table class="table">
                    <thead>
                      <tr>
                        <th>Product Name</th>
                        <th>Price ( {{$order->order->currency}} )</th>
                        <th>Quantity</th>
                        <th>Total</th>
                      </tr>
                    </thead>
									...
									<table align="left" class="column">
										<tr>
											<td>				
												...
												<p>Phone: <strong>123.345.5670</strong><br/>
                Email: <strong><a href="#">info@inddianstore.com</a></strong></p>
